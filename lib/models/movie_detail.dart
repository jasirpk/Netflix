...
class MovieDetatilsModel {
  ...
  factory MovieDetatilsModel.fromRawJson(String str) =>
      MovieDetatilsModel.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory MovieDetatilsModel.fromJson(Map<String, dynamic> json) =>
      MovieDetatilsModel(
        adult: json["adult"],
